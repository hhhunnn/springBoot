...
import com.huna.basic.provider.OAuth2SuccessHandler;
import com.huna.basic.service.implement.OAuth2UserServiceImplement;
...
@Configurable
// @EnableWebSecurity :
// - Web Securirty 설정을 지원하도록 하는 어노테이션
@EnableWebSecurity
        ...
        security
                ...
                .authorizeHttpRequests(request -> request
                    ...
                    .oauth2Login(oauth2 -> oauth2
                        // Oauth 인증 서버에서 redirection 하는 URL 지정 (깃허브 Authorization callback URL 부분)
